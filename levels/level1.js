const level1 = new level(
        ...
        [
            ...
            new BackgroundObject('img/3. Background/Layers/5. Water/D2.png', 299*5, 0),
            new BackgroundObject('img/3. Background/Layers/4.Fondo 2/D2.png', 299*5, 0),
            new BackgroundObject('img/3. Background/Layers/3.Fondo 1/D2.png', 299*5, 0),
            new BackgroundObject('img/3. Background/Layers/1. Light/2.png', 299*5, 0),
            new BackgroundObject('img/3. Background/Layers/2. Floor/D2.png', 299*5, 0),
        ],
)